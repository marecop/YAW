            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden animate-fade-in">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 border-t border-gray-100">
                  <Link 
                    href={`/zh-hk/flight-status?search=${encodeURIComponent(result.flightNumber)}&date=${encodeURIComponent(selectedDate)}`}
                  ...
                  <Link 
                    href={`/zh-hk/flights/search?from=${encodeURIComponent(result.from)}&to=${encodeURIComponent(result.to)}&departureDate=${encodeURIComponent(selectedDate)}`}
