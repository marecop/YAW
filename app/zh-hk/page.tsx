      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-10">
            ...
            <Link href="/zh-hk/destinations" className="hidden md:flex items-center px-6 py-3 rounded-xl bg-gray-50 text-gray-900 font-semibold hover:bg-gray-100 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {popularDestinations.map((destination) => (
              <Link 
                href={`/zh-hk/flights?to=${destination.code}`} 
                key={destination.id}
          ...
          <div className="mt-8 text-center md:hidden">
            <Link href="/zh-hk/destinations" className="inline-block px-8 py-4 bg-gray-100 rounded-xl font-bold text-gray-900">
              查看更多目的地
            </Link>
          </div>
        </div>
