      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-yellow max-w-none space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              黃色航空重視您的個人信息保護。我們會按照《個人資料（私隱）條例》等相關法律法規和我們的《<Link href="/zh-hk/privacy" className="text-ya-yellow-600 hover:text-ya-yellow-700">私隱政策</Link>》收集、使用、存儲和保護您的個人信息。請在使用本網站前仔細閱讀我們的《私隱政策》。
            </p>
            <p className="text-gray-600 mt-2">
