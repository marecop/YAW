      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              已有帳戶？{' '}
              <Link href="/zh-cn/auth/login" className="font-medium text-ya-yellow-600 hover:text-ya-yellow-500">
                立即登入
              </Link>
            </p>
          </div>
          ...
          {error && (
            <div className="mb-4 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded">
              ...
              <p className="mt-6 text-xs text-center text-gray-500">
                註冊即表示你同意{' '}
                <Link href="/zh-cn/terms" className="text-ya-yellow-600 hover:text-ya-yellow-500">
                  服務條款
                </Link>{' '}
                及{' '}
                <Link href="/zh-cn/privacy" className="text-ya-yellow-600 hover:text-ya-yellow-500">
                  私隱政策
                </Link>
              </p>
        </div>
