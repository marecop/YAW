  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="flex mb-8" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2">
            ...
            <li className="flex items-center">
              ...
              <span className="ml-2 text-gray-900 font-medium">法律聲明</span>
            </li>
          </ol>
        </nav>
        ...
        <p className="text-gray-500 text-sm mb-8">最後更新日期：2025年10月27日</p>
        
        <div className="prose prose-yellow max-w-none space-y-8">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">1. 信息與數據</h2>
            <p className="text-gray-600 mt-2">
              黃色航空（Yellow Airlines）網站（以下簡稱「本網站」）及其所有內容均為黃色航空所有，受埃森蘭人民共和國著作權法、商標法及其他知識產權法律法規的保護。未經黃色航空書面許可，任何單位及個人不得以任何方式或理由對本網站的任何部分進行使用、複製、修改、傳播、展示或發行。
            </p>
            <p className="text-gray-600 mt-2">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              本網站的所有內容，包括但不限於文字、圖片、標誌、音頻、視頻、軟件、代碼及其組合，均受埃森蘭人民共和國著作權法和國際著作權法的保護。未經黃色航空明確書面許可，任何人不得以任何形式或通過任何方式複製、修改、傳輸、展示或使用這些內容。
            </p>
            <p className="text-gray-600 mt-2">
              「黃色航空」和「Yellow Airlines」及相關標誌均為黃色航空的商標或註冊商標，受埃森蘭人民共和國商標法和國際商標法的保護。未經黃色航空書面許可，任何單位或個人不得以任何方式使用這些商標。
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              黃色航空重視您的個人信息保護。我們會按照《個人資料（私隱）條例》等相關法律法規和我們的《<Link href="/zh-cn/privacy" className="text-ya-yellow-600 hover:text-ya-yellow-700">私隱政策</Link>》收集、使用、存儲和保護您的個人信息。請在使用本網站前仔細閱讀我們的《私隱政策》。
            </p>
            <p className="text-gray-600 mt-2">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              您在使用本網站時，必須遵守中華人民共和國香港特別行政區的法律法規及其他相關法規，並尊重網絡道德。您不得使用本網站從事任何違法活動，包括但不限於：
            </p>
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              本法律聲明的解釋、效力及爭議解決均適用中華人民共和國香港特別行政區法律。
            </p>
            <p className="text-gray-600 mt-2">
              因使用本網站而引起的或與本網站有關的任何爭議，雙方應友好協商解決。協商不成的，任何一方均可向黃色航空所在地有管轄權的法院提起訴訟。
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              本網站的所有內容版權均屬於黃色航空或其內容提供者所有，受埃森蘭人民共和國著作權法和國際著作權條約保護。
            </p>
            <p className="text-gray-600 mt-2">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              黃色航空是根據埃森蘭人民共和國《公司法》註冊成立的企業，擁有合法的商業登記和航空運營資質。公司註冊證號：MYHKC-69128
            </p>
            <p className="text-gray-600 mt-2 font-medium text-red-600">
              註：本網站為教育示例，非真實航空公司網站。所有內容純屬虛構，僅供展示用途，不代表任何真實企業或服務。
            </p>
          </div>
