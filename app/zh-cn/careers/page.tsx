      ...
      <nav className="flex mb-8" aria-label="Breadcrumb">
        <ol className="flex items-center space-x-2 text-sm">
          ...
          <li className="flex items-center">
            ...
            <span className="ml-2 text-gray-900 font-medium">工作機會</span>
          </li>
        </ol>
      </nav>
      ...
      <div className="bg-ya-yellow-50 rounded-lg p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold mb-3 text-ya-yellow-600">創新精神</h3>
            <p className="text-gray-600">我們鼓勵員工思考創新，不斷尋求改進和優化服務的方法。</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold mb-3 text-ya-yellow-600">團隊合作</h3>
            <p className="text-gray-600">我們相信通過團隊合作，可以實現更大的成就並提供更好的服務。</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold mb-3 text-ya-yellow-600">多元包容</h3>
            <p className="text-gray-600">我們尊重並珍視每個人的獨特背景和觀點，創造一個包容的工作環境。</p>
          </div>
        </div>
      </div>
