  ...
  return (
    <main className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <nav className="flex mb-8" aria-label="Breadcrumb">
        <ol className="flex items-center space-x-2 text-sm">
          ...
          <li className="flex items-center">
            ...
            <span className="ml-2 text-gray-900 font-medium">常見問題</span>
          </li>
        </ol>
      </nav>
        ...
        <div className="lg:col-span-1">
          <div className="bg-gray-50 rounded-lg p-4 sticky top-20">
            ...
            <div className="mt-8 p-4 bg-ya-yellow-50 rounded-lg">
              <h3 className="font-medium text-ya-yellow-800 mb-2">需要更多幫助？</h3>
      ...
      <div className="mt-16 bg-gray-50 rounded-lg p-8 text-center">
        <h2 className="text-2xl font-semibold mb-4">仍有疑問？</h2>
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          我們的客戶服務團隊隨時準備為您提供幫助。請通過以下方式聯繫我們。
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg">
            ...
            <h3 className="font-medium text-gray-900 mb-1">客服電話</h3>
            <a href="tel:+8618122317910" className="text-ya-yellow-600 hover:underline">
              +86 181 2231 7910
            </a>
            <p className="text-sm text-gray-500 mt-1">週一至週日 9:00-21:00</p>
          </div>
        </div>
      </div>
    </main>
