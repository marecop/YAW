...
export default function FlightSearchPage() {
  ...
  const handleSelectCabin = (flightId: string, cabinType: string) => {
    router.push(`/zh-cn/flights/${flightId}/book?from=${from}&to=${to}&departureDate=${selectedDate || departureDate}&passengers=${passengers}&cabinClass=${cabinType}`)
  }
  ...
  const handleDateChange = (newDate: string) => {
    ...
    router.push(`/zh-cn/flights/search?${newParams.toString()}`, { scroll: false })
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-yellow-50">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm text-text-secondary">出發</div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm text-text-secondary">旅客</div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          >
            <option value="departure">排序依據：最相關</option>
            <option value="price">最低價格</option>
            <option value="duration">最短時長</option>
          </select>
        </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1 px-4 text-center">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="text-xs text-text-secondary px-2">直達</div>
                            <div className="flex-1 h-px bg-border"></div>
                          </div>
                        </div>
                        ...
                        >
                          <div className="space-y-2">
                            <div className={`text-xs font-semibold uppercase ${cabin.available ? 'text-navy' : 'text-gray-400'}`}>
                              {cabin.type === 'ECONOMY' && '經濟艙'}
                              {cabin.type === 'PREMIUM_ECONOMY' && '進階經濟艙'}
                              {cabin.type === 'BUSINESS' && '商務艙'}
                              {cabin.type === 'FIRST_CLASS' && '頭等艙'}
                            </div>
        ...
        {filteredConnections.length > 0 && (
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-navy mb-4">中轉航班</h2>
        ...
        {filteredFlights.length === 0 && filteredConnections.length === 0 && !isLoading && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-navy mb-2">未找到符合條件的航班</h3>
            <p className="text-text-secondary">請嘗試調整搜索條件</p>
          </div>
        )}
      </div>
    </div>
