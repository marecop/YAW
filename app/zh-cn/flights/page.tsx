      ...
      <div className="min-h-screen bg-gray-50 pt-32 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">預訂航班</h1>
            <p className="text-xl text-gray-600">輕啟旅程，飛向更遠</p>
          </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">正在搜尋航班...</p>
          <p className="mt-2 text-sm text-gray-500">請稍候，我哋正在為你查找最合適嘅航班</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">搜尋失敗</h2>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">未找到航班</h2>
          <p className="text-gray-600 mb-6">請嘗試修改搜索條件</p>
          <button
