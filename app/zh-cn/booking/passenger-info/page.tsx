...
function PassengerInfoContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 跳转到支付页面
      router.push(`/zh-cn/booking/payment?bookingId=${booking.id}`)
    } catch (err: any) {
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="flex items-center">
              ...
              <Link href="/zh-cn/flights" className="ml-2 text-gray-500 hover:text-gray-700">
                航班搜索
              </Link>
            </li>
            <li className="flex items-center">
              ...
              <Link href="/zh-cn/booking/select-cabin" className="ml-2 text-gray-500 hover:text-gray-700">
                選取票價
              </Link>
            </li>
            <li className="flex items-center">
