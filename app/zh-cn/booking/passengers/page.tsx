...
function PassengersPageContent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isRoundtrip) {
      ...
      router.push(`/zh-cn/booking/payment?${params.toString()}`)
    } else {
      // 单程机票
      // 確保 cabinClass 不為空
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm">
            <li>
              <Link href="/zh-cn/" className="text-gray-500 hover:text-gray-700">首頁</Link>
            </li>
            <li className="flex items-center">
              <svg className="h-4 w-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
              </svg>
              <span className="ml-2 text-gray-900 font-medium">乘客信息</span>
            </li>
          </ol>
        </nav>
        ...
        {isRoundtrip ? (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">往返航班信息</h2>
            
            {outboundFlight && (
              <div className="mb-4 pb-4 border-b">
                <h3 className="font-semibold text-gray-900 mb-2">去程航班</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    <span className="text-gray-600">航線:</span>
            ...
            {inboundFlight && (
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">返程航班</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div>
                    <span className="text-gray-600">航班號:</span>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">航班信息</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                <span className="text-gray-600">航班號:</span>
