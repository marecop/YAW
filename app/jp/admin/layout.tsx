...
export default function AdminLayout({
  ...
  const navigation = [
    { name: 'ダッシュボード', href: '/jp/admin', icon: LayoutDashboard },
    { name: 'フライト管理', href: '/jp/admin/flights', icon: Plane },
    { name: '予約管理', href: '/jp/admin/bookings', icon: Calendar },
    { name: 'ユーザー管理', href: '/jp/admin/users', icon: Users },
    { name: '特別サポート', href: '/jp/admin/special-assistance', icon: MessageSquare },
    { name: 'キャッシュ管理', href: '/jp/admin/clear-cache', icon: Trash2 },
    { name: 'メッセージセンター', href: '/jp/admin/messages', icon: MessageSquare },
  ]
