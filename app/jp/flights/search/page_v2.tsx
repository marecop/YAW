...
export default function FlightSearchPage() {
  ...
  const handleSelectCabin = (flightId: string, cabinType: string) => {
    router.push(`/jp/flights/${flightId}/book?from=${from}&to=${to}&departureDate=${selectedDate || departureDate}&passengers=${passengers}&cabinClass=${cabinType}`)
  }
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1 px-4 text-center">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="text-xs text-text-secondary px-2">直行便</div>
                            <div className="flex-1 h-px bg-border"></div>
                          </div>
                        </div>
