...
export default function Home() {
  ...
  const popularDestinations = [
    { id: 1, name: '東京', code: 'NRT', imageUrl: '/images/tokyo.png', price: 'HK$4,500', tags: ['ショッピング', 'グルメ'] },
    { id: 2, name: 'ロンドン', code: 'LHR', imageUrl: '/images/london.png', price: 'HK$6,500', tags: ['歴史', '文化'] },
    { id: 3, name: 'ニューヨーク', code: 'JFK', imageUrl: '/images/newyork.png', price: 'HK$7,800', tags: ['賑やか', '芸術'] },
    { id: 4, name: 'シンガポール', code: 'SIN', imageUrl: '/images/Singapore.png', price: 'HK$4,200', tags: ['ガーデンシティ'] },
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 text-white lg:text-left text-center">
              ...
              <h1 className="text-5xl lg:text-6xl font-extrabold text-black mb-6 leading-tight">
                世界を探索する<br/>
                <span className="text-white drop-shadow-md">ここから始まる</span>
              </h1>
              <p className="text-xl text-black/80 font-medium mb-8 leading-relaxed">
                ビジネスでもレジャーでも、イエロー航空は最も快適で安全な飛行体験を提供します。
              </p>
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <div className="flex items-center gap-3">
                   ...
                   <div className="text-left">
                     <p className="text-xs text-black/60 font-bold uppercase">安全認証</p>
                     <p className="text-sm text-black font-bold">5つ星の安全性</p>
                   </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                   ...
                   <div className="text-left">
                     <p className="text-xs text-black/60 font-bold uppercase">定時運航率</p>
            ...
            <div className="lg:col-span-7">
              <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8 transform transition-transform hover:scale-[1.01] duration-300">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">多様な支払い方法</span>
                </div>
                <FlightSearchForm />
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-10">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">人気の目的地</h2>
              <p className="text-gray-500 text-lg">人気の路線を厳選、見逃せない特別価格</p>
            </div>
            <Link href="/jp/destinations" className="hidden md:flex items-center px-6 py-3 rounded-xl bg-gray-50 text-gray-900 font-semibold hover:bg-gray-100 transition-colors">
              すべての目的地を見る <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {popularDestinations.map((destination) => (
              <Link 
                href={`/jp/flights?to=${destination.code}`} 
                key={destination.id}
              ...
              >
                <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between bg-white relative">
                    ...
                    <div>
                      <div className="text-sm text-gray-500 mb-1">行き</div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-4">{destination.name}</h3>
                    </div>
                    
                    <div className="pt-4 border-t border-gray-100 flex items-end justify-between">
                      <div>
                        <p className="text-xs text-gray-400 mb-1">往復（税込）</p>
                      ...
                      <span className="text-sm font-semibold text-gray-900 group-hover:text-ya-yellow-600 transition-colors">今すぐ予約 &rarr;</span>
                    </div>
                  </div>
                </div>
              </Link>
          ...
          <div className="mt-8 text-center md:hidden">
            <Link href="/jp/destinations" className="inline-block px-8 py-4 bg-gray-100 rounded-xl font-bold text-gray-900">
              目的地をもっと見る
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">イエロー航空体験</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">なぜイエロー航空なのか？</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">快適なキャビン</h3>
              <p className="text-gray-600 leading-relaxed">
                人間工学に基づいた座席設計、広々とした足元スペースで、長距離フライトも快適に。
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">機内食</h3>
              <p className="text-gray-600 leading-relaxed">
                スターシェフによる機内メニューと厳選されたワインで、空の上の美食体験を。
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">心のこもったサービス</h3>
              <p className="text-gray-600 leading-relaxed">
                プロの客室乗務員が常にお客様のニーズに気を配り、きめ細やかなサービスを提供します。
              </p>
            </div>
          </div>
        </div>
