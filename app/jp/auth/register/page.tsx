        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              イエロー航空にご登録いただきありがとうございます。
            </p>
            <p className="mt-4 text-sm text-gray-600">
              <span className="font-medium text-gray-900">{formData.email}</span> に確認メールを送信しました。
              <br />
              メールを確認し、リンクをクリックして認証を完了してください。
            </p>
          </div>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              すでにアカウントをお持ちですか？{' '}
              <Link href="/jp/auth/login" className="font-medium text-ya-yellow-600 hover:text-ya-yellow-500">
                ログイン
              </Link>
            </p>
          </div>
          ...
          {error && (
            <div className="mb-4 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded">
              ...
              <p className="mt-6 text-xs text-center text-gray-500">
                登録することで、以下に同意したことになります：{' '}
                <Link href="/jp/terms" className="text-ya-yellow-600 hover:text-ya-yellow-500">
                  利用規約
                </Link>{' '}
                および{' '}
                <Link href="/jp/privacy" className="text-ya-yellow-600 hover:text-ya-yellow-500">
                  プライバシーポリシー
                </Link>
              </p>
        </div>
