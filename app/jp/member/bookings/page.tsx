...
export default function BookingsPage() {
  ...
  useEffect(() => {
    if (!authLoading && !isAuthenticated) {
      router.push('/jp/auth/login?redirect=/member/bookings')
      return
    }
      ...
      <div className="container-custom">
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-text-secondary">すべての予約を確認・管理できます</p>
          </div>
          <Link
            href="/jp/"
        ...
        {bookings.length === 0 ? (
          <div className="card-modern p-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-navy mb-2">予約がありません</h2>
            <p className="text-text-secondary mb-6">
              予約履歴がありません。旅行の計画を始めましょう！
            </p>
            <Link
              href="/jp/"
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      <div>
                        <p className="text-sm text-text-secondary mb-1">出発</p>
                      ...
                      <div className="flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-xs text-text-secondary">直行便</p>
                        </div>
                      </div>

                      <div className="text-right md:text-left">
                        <p className="text-sm text-text-secondary mb-1">到着</p>
                        <p className="text-xl font-bold text-navy">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-text-secondary">
                      ...
                      <div>乗客：{booking.passengerName}</div>
                      <div>クラス：{booking.cabinClass}</div>
                      {booking.seatNumber && <div>座席：{booking.seatNumber}</div>}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-end gap-3 lg:border-l lg:pl-6">
                    <div className="text-right mb-2">
                      <p className="text-sm text-text-secondary">合計</p>
                    ...
                    <div className="flex flex-col gap-2 w-full lg:w-auto">
                          ...
                          return (
                            <div className="px-4 py-2 bg-blue-50 border border-blue-200 rounded-lg text-center">
                              <p className="text-xs text-blue-800">
                                {daysUntilOpen > 0 ? `${daysUntilOpen}日後に` : 'まもなく'}チェックイン開始
                              </p>
                            </div>
                          )
                      ...
                      <Link
                        href={`/jp/member/bookings/${booking.id}`}
