    ...
    try {
      ...
      for (let i = 0; i < passengerData.length; i++) {
        ...
        if (!passenger.firstName || !passenger.lastName || !passenger.email) {
          throw new Error(`乗客 ${i + 1} の必須情報をすべて入力してください`)
        }
      }
      ...
      // 跳转到支付页面
      router.push(`/jp/booking/payment?bookingId=${booking.id}`)
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="flex items-center">
              ...
              <Link href="/jp/booking/select-cabin" className="ml-2 text-gray-500 hover:text-gray-700">
                運賃選択
              </Link>
            </li>
            <li className="flex items-center">
        ...
        {/* 标题 */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">乗客情報</h1>
          <p className="text-gray-600">全ての乗客の詳細情報を入力してください</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">料金概要</h2>
