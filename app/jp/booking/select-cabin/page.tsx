...
function SelectCabinContent() {
    ...
    },
    {
      ...
      features: {
        ...
        specialFeatures: [
          ...
          '10% 持続可能な航空燃料 (SAF)',
          '90% 気候プロジェクト',
          'さらに 10% ボーナスマイルと 10% ポイント・資格ポイント'
        ]
      }
    },
    {
      id: 'premium-flex',
      name: 'プレミアムエコノミー フレックスプラス',
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    router.push(`/jp/booking/passenger-info?${params.toString()}`)
  }
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="flex items-center">
              ...
              <Link href="/jp/flights" className="ml-2 text-gray-500 hover:text-gray-700">
                フライト検索
              </Link>
            </li>
            <li className="flex items-center">
              ...
              <span className="ml-2 text-gray-900 font-medium">運賃選択</span>
            </li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {options.map((option) => (
            ...
            >
              ...
              <div className="p-6">
                {/* 座位数 */}
                <div className="text-xs text-gray-600 mb-2">{option.seatsAvailable} 席の空きあり</div>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-xs">
                      <div className="font-medium text-gray-900">予約変更</div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-xs">
                      <div className="font-medium text-gray-900">払い戻し</div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-xs">
                      <div className="font-medium text-gray-900">機内持ち込み手荷物</div>
                  ...
                  {option.features.personalItem.allowed && (
                    <div className="flex items-start gap-2">
                      <Luggage className="w-4 h-4 text-gray-600 mt-0.5 flex-shrink-0" />
                      <div className="text-xs">
                        <div className="font-medium text-gray-900">身の回り品 1個</div>
                  ...
                  <div className="flex items-start gap-2">
                    <Luggage className="w-4 h-4 text-gray-600 mt-0.5 flex-shrink-0" />
                    <div className="text-xs">
                      <div className="font-medium text-gray-900">受託手荷物</div>
                      <div className="text-gray-600">
                  ...
                  {option.features.seatSelection.included && (
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-xs">
                        <div className="font-medium text-gray-900">座席指定 (空席がある場合)</div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-xs">
                      <div className="font-medium text-gray-900">機内食</div>
