      ...
      <div className="min-h-screen bg-gray-50 pt-32 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">{t('nav.bookFlight')}</h1>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">{t('flights.searching')}</p>
          <p className="mt-2 text-sm text-gray-500">{t('flights.searchingDesc')}</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('flights.error')}</h2>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('flights.noFlightsFound')}</h2>
          <p className="text-gray-600 mb-6">{t('flights.noFlightsDesc')}</p>
          <button
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className={`lg:w-1/4 lg:block ${showFilters ? 'block' : 'hidden'}`}>
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              ...
              {/* Price Filter */}
              <div className="mb-8">
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">價格範圍</h3>
                <input
                  type="range"
                  min="0"
                  max={maxPrice}
              ...
              <div>
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">轉機次數</h3>
                <div className="space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700">直飛</span>
                  </label>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 text-sm text-gray-500 mb-1">
                    <span>單程</span>
                    <span>•</span>
                    <span>{passengers} 乘客</span>
                    <span>•</span>
                    <span>{t('flights.economy')}</span>
                  </div>
        ...
        <div className="space-y-4">
              {filteredFlights.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">沒有符合篩選條件的航班</h3>
                  <p className="text-gray-500 mb-6">請嘗試調整您的篩選條件或重新搜索</p>
                  <button
                    onClick={() => {
