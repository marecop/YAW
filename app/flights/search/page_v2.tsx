...
export default function FlightSearchPage() {
  ...
  const handleSelectCabin = (flightId: string, cabinType: string) => {
    router.push(`/flights/${flightId}/book?from=${from}&to=${to}&departureDate=${selectedDate || departureDate}&passengers=${passengers}&cabinClass=${cabinType}`)
  }
  ...
  const handleDateChange = (newDate: string) => {
    ...
    router.push(`/flights/search?${newParams.toString()}`, { scroll: false })
  }
