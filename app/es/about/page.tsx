      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-gray-500 font-light">
            Aviación - Unidos por el mismo propósito, creando pasión.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Descubre la compañía detrás de la Grulla Amarilla.
            </p>
          ...
          <div className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Yellow Airlines Cargo es confiable: transportamos tus mercancías rápidamente y de forma segura a destinos en todo el mundo.
            </p>
            <div className="flex items-center text-gray-500 group-hover:text-primary transition-colors mt-auto">
              <div className="border border-current rounded-full p-1 mr-3">
                <ArrowRight className="w-4 h-4" />
          ...
          <div className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Formando la próxima generación de pilotos y tripulantes.
            </p>
            <div className="flex items-center text-gray-500 group-hover:text-primary transition-colors mt-auto">
              <div className="border border-current rounded-full p-1 mr-3">
                <ArrowRight className="w-4 h-4" />
          ...
          <div className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Descubre el proveedor de mantenimiento, reparación y reacondicionamiento líder. Yellow Airlines Technics es un experto en aeronaves civiles, motores y componentes.
            </p>
            <div className="flex items-center text-gray-500 group-hover:text-primary transition-colors mt-auto">
              <div className="border border-current rounded-full p-1 mr-3">
                <ArrowRight className="w-4 h-4" />
