...
function FlightSearchContent() {
  ...
  const handleSelectCabin = (flightId: string, cabinType: string, flight: Flight) => {
    ...
    const params = new URLSearchParams({
      ...
      // Pass single passenger price (passengers page will calculate total price automatically)
      price: cabinPrice.toString()
    })
    
    console.log('🎫 Cabina seleccionada:', {
      cabinType,
      cabinPrice,
      flightDate: selectedDate || departureDate,
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-12 gap-6 p-6">
                  ...
                  <div className="col-span-12 lg:col-span-5">
                    <div className="space-y-4">
                      ...
                      {/* Time and Cities - Larger and clearer */}
                              ...
                              {cabin.available ? (
                                <>
                                  ...
                                  <div className="space-y-1">
                                    <div className="text-xs text-text-secondary">Desde</div>
                                  ...
                                  <div className="pt-2 border-t border-gray-100">
                                    <div className="flex items-center gap-1 text-xs text-green-600">
                                      ...
                                      <span>{cabin.seats} asientos</span>
                                    </div>
                                  </div>
        ...
        {filteredFlights.length === 0 && filteredConnections.length === 0 && !isLoading && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-navy mb-2">No se encontraron vuelos que coincidan con sus criterios</h3>
