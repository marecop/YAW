...
function FlightsPageContent() {
  ...
  useEffect(() => {
    ...
    if (!versionMatches) {
      console.log('🔄 La versión de la base de datos ha sido actualizada, borrando caché y actualizando...')
      setTimeout(() => {
  ...
  const fetchFlights = async () => {
    ...
    try {
      ...
      console.log('🔍 Buscando vuelos...', { from, to, departDate })
  ...
  // Si no hay parámetros de búsqueda, mostrar formulario
  if (!hasSearchParams) {
    return (
      <div className="min-h-screen bg-gray-50 pt-32 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Reservar vuelos</h1>
            <p className="text-xl text-gray-600">Inicie su viaje, vuele más lejos</p>
          </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">Por favor espere, estamos buscando los mejores vuelos para usted</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">No se encontraron vuelos</h2>
          <p className="text-gray-600 mb-6">Por favor intente modificar los criterios de búsqueda</p>
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className={`lg:w-1/4 lg:block ${showFilters ? 'block' : 'hidden'}`}>
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              ...
              {/* Price Filter */}
              <div className="mb-8">
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">Rango de precios</h3>
                <input
                  type="range"
                  min="0"
                  max={maxPrice}
              ...
              {/* Airline Filter */}
              <div className="mb-8">
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">Aerolíneas</h3>
              ...
              <div>
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">Escalas</h3>
                <div className="space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700">Directo</span>
                  </label>
          ...
          <div className="flex-1">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-600 mt-1">
                    {new Date(departDate).toLocaleDateString('es-ES', { weekday: 'short', month: 'long', day: 'numeric' })}
              </div>
            </div>
            <button
            ...
            >
                  ...
                  {showSearch ? 'Ocultar búsqueda' : 'Modificar búsqueda'}
            </button>
          </div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="text-gray-600">
                Mostrando <span className="font-bold text-gray-900">{filteredFlights.length}</span> vuelos
          </div>
        ...
        <div className="space-y-4">
              {filteredFlights.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No se encontraron vuelos que coincidan con los filtros</h3>
                  <p className="text-gray-500 mb-6">Por favor intente ajustar sus filtros o busque de nuevo</p>
                  <button
                    onClick={() => {
