      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 mb-8">
          ...
          <p className="text-gray-600">
            Mascotas pequeñas pueden acompañarlo en la cabina, sujeto a solicitud previa y cumplimiento de las regulaciones pertinentes.
          </p>
        </div>
          ...
          <div className="mb-8">
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={3}
                placeholder="Por favor complete la información de vacunación"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ya-yellow-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="Por favor complete la información del certificado de salud"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ya-yellow-500 focus:border-transparent"
              />
            </div>
