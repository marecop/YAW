      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 mb-8">
          ...
          <p className="text-gray-600">
            Si necesita orientación de tránsito, asistencia de idioma o movilidad, por favor envíe su solicitud con anticipación.
          </p>
        </div>
          ...
          <div className="mb-8">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="Ej: Cantonés / Inglés / Japonés"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ya-yellow-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="Ej: Sala de llegadas / Mostrador de tránsito"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ya-yellow-500 focus:border-transparent"
              />
            </div>
