...
export default function AdminLayout({
  ...
  const navigation = [
    { name: 'Panel de Control', href: '/es/admin', icon: LayoutDashboard },
    { name: 'Vuelos', href: '/es/admin/flights', icon: Plane },
    { name: 'Reservas', href: '/es/admin/bookings', icon: Calendar },
    { name: 'Usuarios', href: '/es/admin/users', icon: Users },
    { name: 'Asistencia Especial', href: '/es/admin/special-assistance', icon: MessageSquare },
    { name: 'Gestión de Caché', href: '/es/admin/clear-cache', icon: Trash2 },
    { name: 'Mensajes', href: '/es/admin/messages', icon: MessageSquare },
  ]
