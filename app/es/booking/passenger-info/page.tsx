    ...
    try {
      ...
      for (let i = 0; i < passengerData.length; i++) {
        ...
        if (!passenger.firstName || !passenger.lastName || !passenger.email) {
          throw new Error(`Por favor complete todos los campos obligatorios para el pasajero ${i + 1}`)
        }
      }
      ...
      router.push(`/es/booking/payment?bookingId=${booking.id}`)
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="flex items-center">
              ...
              <Link href="/es/booking/select-cabin" className="ml-2 text-gray-500 hover:text-gray-700">
                Seleccionar Tarifa
              </Link>
            </li>
            <li className="flex items-center">
              ...
              <span className="ml-2 text-gray-900 font-medium">Datos del Pasajero</span>
            </li>
          </ol>
        </nav>
        ...
        {/* Title */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Datos del Pasajero</h1>
          <p className="text-gray-600">Por favor complete la información detallada de todos los pasajeros</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Resumen de Precio</h2>
