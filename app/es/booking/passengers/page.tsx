      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="flex items-center">
              ...
              <span className="ml-2 text-gray-900 font-medium">Información del pasajero</span>
            </li>
          </ol>
        </nav>
        ...
        {isRoundtrip ? (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Información de vuelo (Ida y Vuelta)</h2>
            
            {outboundFlight && (
              <div className="mb-4 pb-4 border-b">
                <h3 className="font-semibold text-gray-900 mb-2">Vuelo de ida</h3>
            ...
            {inboundFlight && (
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Vuelo de vuelta</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div>
                    <span className="text-gray-600">Vuelo:</span>
            ...
            <div className="mt-4 pt-4 border-t">
              <div className="text-sm">
                ...
                <span className="ml-2 font-medium">
                  ...
                  {cabinClass === 'FIRST_CLASS' && 'Primera Clase'}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Información de vuelo</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                <span className="text-gray-600">Vuelo:</span>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mt-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Detalles del costo</h3>
