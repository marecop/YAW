...
function FlightSearchContent() {
  ...
  useEffect(() => {
    const fetchFlights = async () => {
      ...
      try {
        ...
        if (!directRes.ok) {
          throw new Error(directData.error || 'Search failed')
        }
  ...
  const handleSelectCabin = (flightId: string, cabinType: string, flight: Flight) => {
    ...
    router.push(`/en/booking/passengers?${params.toString()}`)
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-yellow-50 py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-text-secondary">Searching flights...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-yellow-50">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm text-text-secondary">Depart</div>
                  <div className="font-medium text-navy">
                    {format(new Date(selectedDate || departureDate), 'MMM dd (E)')}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="font-medium text-navy">{passengers} Person(s)</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          >
            <option value="departure">Sort by: Best Match</option>
                  ...
                  <div className="col-span-12 lg:col-span-5">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2 text-xs text-text-secondary bg-gray-50 px-3 py-2 rounded-lg">
                        ...
                        <span>
                          {format(new Date(flight.departureTime), 'yyyy-MM-dd EEEE')}
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        {filteredConnections.length > 0 && (
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-navy mb-4">Connecting Flights</h2>
        ...
        {filteredFlights.length === 0 && filteredConnections.length === 0 && !isLoading && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-navy mb-2">No flights found matching your criteria</h3>
            <p className="text-text-secondary">Please try adjusting your search criteria</p>
          </div>
        )}
      </div>
    </div>
