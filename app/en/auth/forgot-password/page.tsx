        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              We have sent an email with a password reset link to <span className="font-medium text-gray-900">{email}</span>.
            </p>
            <p className="mt-4 text-sm text-gray-600">
              Please check your inbox (and spam folder if not received). The link will expire in 24 hours.
            </p>
          </div>
