...
export default function BookingsPage() {
  ...
  useEffect(() => {
    if (!authLoading && !isAuthenticated) {
      router.push('/en/auth/login?redirect=/bookings')
    }
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Enter booking number (e.g. YAAB123456)"
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-lg shadow-md p-12 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                {searched ? 'No bookings found' : 'No booking records'}
              </h3>
              <p className="text-gray-600 mb-6">
                {searched 
                  ? 'Please check your booking number is correct' 
                  : 'You have no flight bookings'}
              </p>
              {searched ? (
                <button
                  onClick={() => {
              ...
              {(searched ? bookings : currentList).length === 0 ? (
                <div className="bg-white rounded-lg p-12 text-center border-2 border-dashed border-gray-200">
                  <div className="text-gray-500 text-lg">
                    {activeTab === 'upcoming' ? 'No upcoming journeys' : 'No journey history records'}
                  </div>
                </div>
              ) : (
