...
function PaymentPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (cardNumber.length !== 16) {
      setError('Bitte geben Sie eine gültige 16-stellige Kreditkarte ein')
      setIsProcessing(false)
      return
    }

    if (!expiryDate.match(/^\d{2}\/\d{2}$/)) {
      setError('Bitte geben Sie ein gültiges Ablaufdatum ein (MM/YY)')
      setIsProcessing(false)
      return
    }

    if (cvv.length !== 3) {
      setError('Bitte geben Sie 3 Stellen des CVV ein')
      setIsProcessing(false)
      return
    }
    ...
    try {
      ...
      if (isRoundtrip) {
        ...
        if (!outboundFlightResponse.ok) {
          throw new Error('Kann die Informationen für die Abflug-Flugzeug nicht abrufen')
        }
        ...
        if (!inboundFlightResponse.ok) {
          throw new Error('Kann die Informationen für die Rückflug-Flugzeug nicht abrufen')
        }
        ...
        for (let i = 0; i < passengers.length; i++) {
          ...
          if (!outboundResponse.ok) {
            ...
            throw new Error(`Abflug-Vorbestellung fehlgeschlagen: ${errorData.error || 'Unbekannter Fehler'}`)
          }
          ...
          if (!inboundResponse.ok) {
            ...
            throw new Error(`Rückflug-Vorbestellung fehlgeschlagen: ${errorData.error || 'Unbekannter Fehler'}`)
          }
        }
        
        console.log('✅ 往返航班預訂成功！')
        alert(`Vorbestellung erfolgreich!\nGesamt: HKD ${(outboundPrice + inboundPrice) * passengers.length}`)
        router.push('/de/member/bookings')
        return
        ...
        for (const segmentFlightId of [segment1Id, segment2Id]) {
          for (let i = 0; i < passengers.length; i++) {
            ...
            if (!response.ok) {
              ...
              throw new Error(errorData.error || 'Vorbestellung fehlgeschlagen')
            }
          }
        }
      ...
      if (!flightResponse.ok) {
        throw new Error('Kann die Informationen für die Flugzeug nicht abrufen')
      }
      ...
      if (bookings.length > 0) {
        router.push('/de/bookings')
      }
    } catch (err: any) {
      setError('Zahlungsverarbeitung fehlgeschlagen, bitte versuchen Sie es erneut')
      setIsProcessing(false)
    }
  }
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="flex items-center">
              ...
              <span className="ml-2 text-gray-900 font-medium">Zahlung</span>
            </li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Zahlungsinformationen</h2>
                    <p className="text-sm text-gray-600">Bitte geben Sie Ihre Kreditkarteninformationen ein</p>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Kreditkartennummer <span className="text-red-500">*</span>
                  </label>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Dies ist ein simuliertes Zahlungssystem, das keine tatsächlichen Zahlungen vornimmt
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Bitte geben Sie den Namen des Karteninhabers ein"
                  />
                </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <div className="text-sm text-blue-800">
                    <p className="font-medium mb-1">Sichere Zahlung</p>
                    <p>Ihre Zahlungsinformationen werden verschlüsselt gespeichert. Dies ist ein simuliertes Zahlungssystem, das keine tatsächlichen Zahlungen vornimmt.</p>
                  </div>
                </div>
                  ...
                  >
                    {isProcessing ? (
                      ...
                      <>
                        ...
                        Zahlung bestätigen {formatPrice(totalPrice)}
                      </>
                    )}
                  </button>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Bestellzusammenfassung</h3>
              
              <div className="space-y-3 mb-4">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Passagierzahl:</span>
              ...
              <div className="border-t border-gray-200 pt-4 mb-4">
                <h4 className="font-medium text-gray-900 mb-2">Passagierliste:</h4>
