...
function SelectCabinContent() {
  ...
  const economyOptions: CabinOption[] = [
    {
      ...
      features: {
        modifications: {
          allowed: true,
          fee: 1810,
          notes: 'Maximale Gebühr von HKD 1,810 pro Passagier, zuzüglich der Differenz'
        },
        refund: {
          allowed: false,
          notes: 'Nicht erlaubt'
        ...
        cabinBaggage: {
          pieces: 1,
          weight: 8,
          size: 'Maximale Größe 55 x 40 x 23 cm'
        },
        checkedBaggage: {
          pieces: 2,
          weight: 23
        ...
        personalItem: {
          allowed: true,
          size: 'Maximale Größe 40 x 30 x 15 cm'
        },
        meals: {
          included: true,
          type: 'Essen, Snacks'
    ...
    },
    {
      ...
      features: {
        ...
        refund: {
          allowed: true,
          fee: 1810,
          notes: 'Rückgängig machen erlaubt, aber HKD 1,810 abgezogen'
        },
        cabinBaggage: {
          pieces: 1,
          weight: 8,
  ...
  const premiumEconomyOptions: CabinOption[] = [
    ...
    },
    {
      ...
      features: {
        ...
        specialFeatures: [
          'Grunderer CO2-Fußabdruck',
          '10% SAF',
          '90% Klimaprojekt',
          'Extra 10% Belohnungsmil und 10% Punkte und Qualifikationspunkte'
        ]
      }
    },
    {
  ...
  const handleSelectOption = (optionId: string) => {
    ...
    router.push(`/de/booking/passenger-info?${params.toString()}`)
  }
