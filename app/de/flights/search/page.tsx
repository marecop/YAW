...
function FlightSearchContent() {
  ...
  useEffect(() => {
    const fetchFlights = async () => {
      ...
      try {
        ...
        if (!directRes.ok) {
          throw new Error(directData.error || 'Suchen fehlgeschlagen')
        }
  ...
  const handleSelectCabin = (flightId: string, cabinType: string, flight: Flight) => {
    ...
    router.push(`/de/booking/passengers?${params.toString()}`)
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-yellow-50 py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-text-secondary">正在搜索航班...</p>
        </div>
      </div>
    )
  }
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="font-medium text-navy">
                    {format(new Date(selectedDate || departureDate), 'MM月dd日 (E)', { locale: zhHK })}
                  </div>
                </div>
              </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3 pb-3 border-b-2 border-gray-100">
                        ...
                        <div className="text-right">
                          <div className="text-xs text-text-secondary">Flugstrecke</div>
                      ...
                      <div className="flex items-center gap-2 text-xs text-text-secondary bg-gray-50 px-3 py-2 rounded-lg">
                        ...
                        <span>
                          {format(new Date(flight.departureTime), 'yyyy年MM月dd日 EEEE', { locale: zhHK })}
                        </span>
                      </div>
                    </div>
                  </div>
                              ...
                              {cabin.available ? (
                                <>
                                  ...
                                  <div className="space-y-1">
                                    <div className="text-xs text-text-secondary">Von</div>
