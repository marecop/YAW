...
function FlightsPageContent() {
  ...
  const fetchFlights = async () => {
    ...
    try {
      ...
      console.log('🔍 正在搜索航班...', { from, to, departDate })
      ...
      console.error('❌ 搜索航班失敗:', err.message)
      ...
      <div className="min-h-screen bg-gray-50 pt-32 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Flug buchen</h1>
            <p className="text-xl text-gray-600">Starten Sie Ihre Reise</p>
          </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Flüge suchen...</p>
          <p className="mt-2 text-sm text-gray-500">Bitte warten Sie, wir suchen nach den passenden Flügen</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Suchen fehlgeschlagen</h2>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Keine Flüge gefunden</h2>
          <p className="text-gray-600 mb-6">Bitte versuchen Sie es mit anderen Suchkriterien</p>
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className={`lg:w-1/4 lg:block ${showFilters ? 'block' : 'hidden'}`}>
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              ...
              {/* Price Filter */}
              <div className="mb-8">
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">Preisbereich</h3>
                <input
                  type="ranget("
                  min=")0"
                  max={maxPrice}
              ...
              {/* Airline Filter */}
              <div className="mb-8">
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">航空公司</h3>
              ...
              <div>
                  <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">Umstiege</h3>
                <div className="space-y-2">
          ...
          <div className="flex-1">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-600 mt-1">
                    {new Date(departDate).toLocaleDateString('de-DE', { weekday: 'short', month: 'long', day: 'numeric' })}
              </div>
            </div>
            <button
            ...
            >
                  ...
                  {showSearch ? 'Suchen verbergen' : 'Suchen ändern'}
            </button>
          </div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="text-gray-600">
                Anzeigen <span className="font-bold text-gray-900">{filteredFlights.length}</span> Flüge
          </div>
          <div className="flex items-center gap-2">
                <span className="text-sm text-gray-600 hidden sm:inline">Sortieren nach:</span>
            <select
              value={sortBy}
            ...
            >
              <option value="departure">Abfahrtzeit</option>
              <option value="price">Preis</option>
              <option value="duration">Flugzeit</option>
            </select>
          </div>
        </div>
        ...
        <div className="space-y-4">
              {filteredFlights.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Keine Flüge gefunden</h3>
                  <p className="text-gray-500 mb-6">Bitte versuchen Sie es mit anderen Suchkriterien</p>
                  <button
                    onClick={() => {
