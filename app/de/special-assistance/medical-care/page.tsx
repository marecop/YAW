...
export default function MedicalCarePage() {
  ...
  const medicalEquipmentOptions = [
    { value: 'OXYGEN', label: 'Sauerstoff' },
    { value: 'CPAP', label: 'CPAP Ventilator' },
    { value: 'VENTILATOR', label: 'Ventilator' },
    { value: 'WHEELCHAIR_MEDICAL', label: 'Medizinischer Rollstuhl' },
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 mb-8">
          ...
          <p className="text-gray-600">
            Wenn Sie medizinische Anforderungen haben oder medizinische Geräte mitführen müssen, bitte zuerst eine Anfrage stellen, wir werden uns mit Ihnen in Verbindung setzen.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-md p-8">
          ...
          <div className="mb-8">
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Medizinische Zustände / Anforderungen *
              </label>
              <textarea
                required
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={3}
                placeholder="Beschreiben Sie die medizinischen Informationen"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ya-yellow-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="Beschreiben Sie den Arztschein"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ya-yellow-500 focus:border-transparent"
              />
            </div>
