...
export default function ImmigrationRequirementsPage() {
  ...
  const currentLabels = {
    title: 'Fidvisa-Status',
    subtitle: 'Überprüfen Sie den Fidvisa-Status Ihres Reisepasses.',
    passportLabel: 'Pass / Nationalität',
    destLabel: 'Ziel',
    selectPrompt: 'Bitte wählen...',
    checkBtn: 'Status prüfen',
    visaStatus: 'Visa-Status',
    stayDuration: 'Verbleibsdauer',
    notes: 'Wichtige Hinweise',
    loading: 'Prüfen...',
    sameCountry: 'Keine Aktion erforderlich',
    sameCountryDesc: 'Sie befinden sich in Ihrem Heimatland oder in einer Region, für die Sie bereits eine Aufenthaltsgenehmigung haben.'
  }
  ...
  const getRuleNotes = (r: ImmigrationRule) => {
    return r.notesDe || r.notesEn || r.notesZhCn || r.notesZhHk
  }
