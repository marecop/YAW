      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-gray-500 font-light">
            Fliegen - Zusammenarbeit, Leidenschaft entfachen.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Entdecken Sie die Firma hinter der Grulla.
            </p>
          ...
          <div className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Yellow Airlines Cargo ist zuverlässig: wir transportieren Ihre Waren schnell und sicher zu Zielen auf der ganzen Welt.
            </p>
            <div className="flex items-center text-gray-500 group-hover:text-primary transition-colors mt-auto">
              <div className="border border-current rounded-full p-1 mr-3">
                <ArrowRight className="w-4 h-4" />
          ...
          <div className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Bildung der nächsten Generation von Piloten und Besatzungen.
            </p>
            <div className="flex items-center text-gray-500 group-hover:text-primary transition-colors mt-auto">
              <div className="border border-current rounded-full p-1 mr-3">
                <ArrowRight className="w-4 h-4" />
          ...
          <div className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Erfahren Sie mehr über den führenden Anbieter für Wartung, Reparatur und Überholung. Yellow Airlines Technics ist ein Experte für zivile Flugzeuge, Motoren und Komponenten.
            </p>
            <div className="flex items-center text-gray-500 group-hover:text-primary transition-colors mt-auto">
              <div className="border border-current rounded-full p-1 mr-3">
                <ArrowRight className="w-4 h-4" />
