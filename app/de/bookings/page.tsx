...
export default function BookingsPage() {
  ...
  useEffect(() => {
    if (!authLoading && !isAuthenticated) {
      router.push('/de/auth/login?redirect=/bookings')
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* 标题 */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Meine Buchungen</h1>
          <p className="text-gray-600">Sehen und verwalten Sie Ihre Flüge</p>
        </div>
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Geben Sie die Buchungsnummer ein (z.B.: YAAB123456)"
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-lg shadow-md p-12 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                {searched ? 'Keine Buchungen gefunden' : 'Keine Buchungen vorhanden'}
              </h3>
              <p className="text-gray-600 mb-6">
                {searched 
                  ? 'Bitte überprüfen Sie Ihre Buchungsnummer' 
              ...
              {(searched ? bookings : currentList).length === 0 ? (
                <div className="bg-white rounded-lg p-12 text-center border-2 border-dashed border-gray-200">
                  <div className="text-gray-500 text-lg">
                    {activeTab === 'upcoming' ? 'Keine kommenden Reisen' : 'Keine historischen Reisen'}
                  </div>
                </div>
              ) : (
                ...
                <div key={booking.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <div className="text-sm text-gray-600 mb-1">Buchungsnummer</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="text-sm text-gray-600 mb-1">Flug</div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="text-sm text-gray-600 mb-1">Abflugzeit</div>
                          <div className="font-medium text-gray-900">
                      ...
                      {/* 乘客信息 */}
                      <div>
                        <div className="text-sm text-gray-600 mb-1">Passagier</div>
                        <div className="font-medium text-gray-900">
                          {booking.passengerName}
                        </div>
                        <div className="text-sm text-gray-600">
                          {booking.cabinClass === 'ECONOMY' && 'Economy'}
                          {booking.cabinClass === 'PREMIUM_ECONOMY' && 'Premium Economy'}
                      ...
                      <div className="flex gap-3">
                        ...
                        {booking.checkedIn && (
                          ...
                          >
                            ...
                            <span>Boarding Pass ansehen</span>
                          </Link>
                        )}
                        <Link
                          href={`/de/bookings/${booking.id}`}
