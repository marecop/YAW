...
// 创建邮件传输器
exports.transporter = nodemailer_1.default.createTransport(SMTP_CONFIG);
// 发送预订确认邮件
async function sendBookingConfirmation(emailTo, bookingData) {
    ...
    const formatTime = (time) => time.replace('+1', '');
...
// 發送密碼重置郵件
async function sendPasswordResetEmail(emailTo, token) {
...
// 發送郵箱驗證郵件
async function sendVerificationEmail(emailTo, token) {
