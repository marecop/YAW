...
exports.generateOccupiedSeats = generateOccupiedSeats;
exports.isSeatOccupied = isSeatOccupied;
exports.getAvailableSeatsCount = getAvailableSeatsCount;
exports.getOccupancyPercentage = getOccupancyPercentage;
// 簡單的哈希函數，用於生成確定性的隨機數
 ...
 * @returns 占用率 (0-1)
 */
function calculateOccupancyRate(flightDate, flightId) {
 ...
 * @returns 已占用座位的索引陣列
 */
function generateOccupiedSeats(flightId, flightDate, cabinClass, totalSeats) {
    const date = typeof flightDate === 'string' ? new Date(flightDate) : flightDate;
 ...
 * @returns 是否被占用
 */
function isSeatOccupied(seatIndex, flightId, flightDate, cabinClass, totalSeats) {
 ...
 * @returns 可用座位數量
 */
function getAvailableSeatsCount(flightId, flightDate, cabinClass, totalSeats) {
    const occupiedSeats = generateOccupiedSeats(flightId, flightDate, cabinClass, totalSeats);
 ...
 * @returns 占用率百分比
 */
function getOccupancyPercentage(flightId, flightDate, cabinClass, totalSeats) {
    const occupiedSeats = generateOccupiedSeats(flightId, flightDate, cabinClass, totalSeats);
    return (occupiedSeats.size / totalSeats) * 100;
}
//# sourceMappingURL=seatOccupancy.js.map